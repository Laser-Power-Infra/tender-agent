...
def build_ingestion_graph():
    logger.info("Building ingestion graph: initialize_document -> download_document -> parse_document -> chunk_embed_push")
    ...
    graph.add_edge("parse_document", "chunk_embed_push")
    graph.add_edge("chunk_embed_push", END)
